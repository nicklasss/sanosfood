	...
	print '
				<tr>
					...
					<td width="18%">
				    	...
				    	<div class="mostrable">
							<h5 class="salnombre mostrable" value="'.$categoria->nombre.'"><strong>'.$categoria->nombre.'</strong></h5>
				    	</div>
					</td>
				 	<td>
				    	<div class="editable escondido">
				    	...
				    	<div class="mostrable">
							<h5 class="saldescripcion">'.$categoria->descripcion.'</h5>
				    	</div>
					</td>
					<td width="15%">
				    	<div class="editable escondido">
					  		<button type="button" class="btn btn-xs btn-success btn-guardar btn-editable" data-id="'.$categoria->id.'">Guardar</button>
				    	...
				    	<div class="mostrable">
					   		...
					   		<button type="button" class="btn btn-xs btn-danger btn-eliminar btn-mostrable" data-id="'.$categoria->id.'"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
				    	</div>
					</td>	
				</tr>';
}
?>
				...
				<tr id="ultima">
					...
					<td>
				    	<div class="editable escondido">
					  		<button type="button" class="btn btn-xs btn-success btn-agregar btn-editable" data-id="'.$categoria->id.'">Agregar</button>
					  		<button type="button" class="btn btn-xs btn-warning btn-cancelar btn-editable">Cancelar</button>
				    	</div>
				    	<div class="mostrable">
