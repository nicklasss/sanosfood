  ...
  <div class="form-group">
    ...
    <div class="col-md-10 contenedor">
	    <div class="editable row escondido">
	    	<div class="col-md-8">
		    	<input type="text" class="form-control entrada" value="'.$categoria->nombre.'"/>
    		</div>
	    	<div class="col-md-4">
        		<button type="button" class="btn btn-xs btn-success btn-guardar" data-atributo="nombre" data-id="'.$categoria->id.'">Guardar</button>
        		<button type="button" class="btn btn-xs btn-danger btn-cancelar">Cancelar</button>
	    	</div>	
    	</div>
		<div class="mostrable row">
	    	<div class="col-md-8">
		    	<h4 class="mostrado">'.$categoria->nombre.'</h4>
    		</div>
	    	<div class="col-md-4">
...
print '
  <div class="form-group" style="border-bottom: 1px solid lightgrey">
    ...
    <div class="col-md-10 contenedor">
	    <div class="editable row escondido">
	    	<div class="col-md-8">
		    	<textarea type="text" class="form-control entrada">'.$categoria->descripcion.'</textarea>
    		</div>
	    	<div class="col-md-4">
        		<button type="button" class="btn btn-xs btn-success btn-guardar" data-atributo="descripcion" data-id="'.$categoria->id.'">Guardar</button>
        		<button type="button" class="btn btn-xs btn-danger btn-cancelar">Cancelar</button>
	    	</div>	
    	</div>
		<div class="mostrable row">
	    	<div class="col-md-8">
		    	<h4 class="mostrado">'.$categoria->descripcion.'</h4>
    		</div>
	    	<div class="col-md-4">
        		<button type="button" class="btn btn-xs btn-primary btn-editar"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar</button>
	    	</div>	
