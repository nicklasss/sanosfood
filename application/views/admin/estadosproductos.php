<div class="row">
	<div class="col-md-12">
        <div class="panel panel-default">
			<div class="panel-heading text-center"><h2>Estados de un Producto</h2></div>
	...
	print '
				<tr>
					<td width="18%">
				    	...
				    	<div class="mostrable">
							<h4 class="salnombre mostrable" value="'.$estado->nombre.'">'.$estado->nombre.'</h4>
				    	</div>
					</td>
				 	<td>
				    	<div class="editable escondido">
					...
					<td width="15%">
				    	<div class="editable escondido">
					  		<button type="button" class="btn btn-xs btn-success btn-guardar" data-id="'.$estado->id.'">Guardar</button>
				    	...
				    	<div class="mostrable">
					   		...
					   		<button type="button" class="btn btn-xs btn-danger btn-eliminar" data-id="'.$estado->id.'"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
				    	</div>
					</td>	
				</tr>';
}
?>
				...
				<tr id="ultima">
					...
					<td>
				    	<div class="editable escondido">
					  		<button type="button" class="btn btn-xs btn-success btn-agregar" data-id="'.$estado->id.'">Agregar</button>
					  		<button type="button" class="btn btn-xs btn-warning btn-cancelar">Cancelar</button>
				    	</div>
				    	<div class="mostrable">
